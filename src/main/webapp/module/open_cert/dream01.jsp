...
<%
	...
	String url = request.getScheme()+"://"+ request.getServerName()+"/module/open_cert/dream03.jsp?reqNum="+URLEncoder.encode(reqNum,"UTF-8")+"_";
	url += URLEncoder.encode(id,"UTF-8")+"_"+URLEncoder.encode(phoneNum,"UTF-8");
	
	System.out.println("(신규) 최종 URL : "+url);
%>
<html>
    <head>
        <title>본인인증서비스</title>
