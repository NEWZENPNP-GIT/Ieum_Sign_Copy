...
request.setCharacterEncoding("UTF-8");
  ...
  //encReqInfo = mscr.msgEncrypt(reqInfo,"E:/cert/newzenpnpCert.der"); //로컬
  ...
  rtn_url = request.getParameter("retUrl");      // 본인인증 결과수신 받을 URL
	...
	String param = reqNum+"_"+id+"_"+phoneNum;
...
<table cellpadding=1 cellspacing=1>
	<tr>
		<td align=center>본인인증 요청중입니다.</td>
	</tr>
<!--
    <tr>
...
<!-- 본인인증서비스 요청 form --------------------------->
<form id="reqDRMOKForm" name="reqDRMOKForm" method="get" action="#">
