...
nhn.husky.SE_EditingAreaManager = jindo.$Class({
	...
	$init : function(sDefaultEditingMode, elContentsField, oDimension, fOnBeforeUnload, elAppContainer){
		...
		//TODO _201909005 .se2_input_area husky_seditor_editing_area_container
		this.elEditingAreaContainer.style.width = '100%';
		this.elEditingAreaContainer.style.height = "calc(100% - 47px)";
		if(oWidth.sUnit === "px"){
			//elAppContainer.style.width = (oWidth.nSize + 2) + "px";
			//TODO _201909005 id=smart_editor2
			elAppContainer.style.width = '100%';
			elAppContainer.style.height = '100%';
...
nhn.husky.SE_OuterIFrameControl = $Class({
	...
	$ON_SE_FIT_IFRAME : function(){
		// TODO _20190905 smarteditor/SmartEditor2Skin.html의 iframe
		//this.elIFrame.style.height = document.body.offsetHeight+"px";
		this.elIFrame.style.height = "100%";
	},
