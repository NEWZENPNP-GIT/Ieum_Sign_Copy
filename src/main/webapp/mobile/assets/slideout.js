...
Slideout.prototype._translateXTo = function(translateX) {
  ...
  this.panel.style[prefix + 'transform'] = this.panel.style.transform = 'translateX(' + translateX + 'vw)';
  return this;
};
...
Slideout.prototype._initTouchEvents = function() {
  ...
  this._onTouchMoveFn = function(eve) {
    ...
    if (Math.abs(dif_x) > 20) {
      ...
      self.panel.style[prefix + 'transform'] = self.panel.style.transform = 'translateX(' + translateX + 'vw)';
