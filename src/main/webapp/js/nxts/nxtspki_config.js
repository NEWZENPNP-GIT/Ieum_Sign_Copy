...
nxTSPKIConfig.installPage            = "../../pki/openweb/install/pki/index.jsp";
nxTSPKIConfig.installMessage         = "SCORE PKI for OpenWeb 프로그램이 설치 되어 있지 않거나, 이전 버전이 설치되어 있습니다. \n\n설치페이지로 이동하시겠습니까?";
nxTSPKIConfig.processingImageUrl     = "../../pki/openweb/img/processing2.gif";
...
nxTSPKIConfig.options.bannerUrl = "../pki/img/gpost.bmp";
