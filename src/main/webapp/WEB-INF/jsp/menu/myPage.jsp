...
<div id="myPage_wrap" class="">
	<div class="container">
		<div class="location"><span class="loc_main NanumGothic">게시판 > </span><span class="loc_sub NanumGothic">마이페이지</span></div>
		<div class="pagtit"><span class="NanumGothic">마이페이지</span></div>
		<div class="tit_dec NanumGothic"><span class="speaker"></span><span>안녕하세요 관리자님 </span></div>
