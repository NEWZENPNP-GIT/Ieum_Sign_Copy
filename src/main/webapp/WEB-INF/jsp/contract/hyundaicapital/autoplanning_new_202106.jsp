					...
					<tr>
						...
						<td>
							<select class="txtinput01" id="TXT_00003">
								...
								<option value="동광주지점">동광주지점</option>
								<option value="동대구지점">동대구지점</option>
								<option value="동부산지점">동부산지점</option>
								<option value="동수원지점">동수원지점</option>
								<option value="동작지점">동작지점</option>
