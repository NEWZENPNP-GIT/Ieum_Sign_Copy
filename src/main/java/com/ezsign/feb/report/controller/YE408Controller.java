...
public class YE408Controller {
	...
	// 기부금조정명세서
	@RequestMapping(method = RequestMethod.GET , value = "getYE408List.do")
	@ResponseBody
	public ResponseEntity<JSONObject> getYE408ListCtrl(@ModelAttribute("YE408ReportVO") YE408ReportVO ye408VO,
		...
		try {
			System.out.println(":::::::::::::::::::: getYE408ListCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				ye408VO.setBizId(bizId);
				ye408VO.setBizName(bizName);

				Map<String, Object> result = reportService.getYE408List(ye408VO);
