...
@Controller("reportYE404Controller")
@RequestMapping("/febreport/")
public class YE404Controller {
	...
	@ResponseBody
	public ResponseEntity<JSONObject> getYE404ListCtrl(@ModelAttribute("YE404ReportVO") YE404ReportVO ye404VO,
		...
		try {
			System.out.println(":::::::::::::::::::: getYE404ListCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				ye404VO.setBizId(bizId);
				ye404VO.setBizName(bizName);

				Map<String, Object> result = reportService.getYE404List(ye404VO);
