...
public class AnnuitySavingController {
	...
	@RequestMapping(method = RequestMethod.GET , value = "getAnnuitySaving.do")
	@ResponseBody
	public ResponseEntity<JSONObject> getAnnuitySavingCtrl(@ModelAttribute("AnnuitySavingVO") AnnuitySavingVO annuitySavingVO,
		...
		try {
			System.out.println(":::::::::::::::::::: getAnnuitySavingCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				annuitySavingVO.setBizId(bizId);
				annuitySavingVO.setBizName(bizName);

				Map<String, Object> result = reportService.getAnnuitySaving(annuitySavingVO);
