...
public class YE101Controller {
	...
	// 주택임차 차입금원리금상환 명세서
	@RequestMapping(method = RequestMethod.GET , value = "getYE101List.do")
	@ResponseBody
	public ResponseEntity<JSONObject> getYE101ListCtrl(@ModelAttribute("YE101VO") YE101VO ye101VO,
		...
		try {
			System.out.println(":::::::::::::::::::: getYE101ListCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				ye101VO.setBizId(bizId);
				ye101VO.setBizName(bizName);

				Map<String, Object> result = reportService.getYE101List(ye101VO);
