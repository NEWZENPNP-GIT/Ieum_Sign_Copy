...
public class YE104Controller {
	...
	// 장기주택 저당차입금 명세서
	@RequestMapping(method = RequestMethod.GET , value = "getYE104List.do")
	@ResponseBody
	public ResponseEntity<JSONObject> getYE104ListCtrl(@ModelAttribute("YE104VO") YE104VO ye104VO,
		...
		try {
			System.out.println(":::::::::::::::::::: getHomeMortgageCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				ye104VO.setBizId(bizId);
				ye104VO.setBizName(bizName);

				Map<String, Object> result = reportService.getYE104List(ye104VO);
