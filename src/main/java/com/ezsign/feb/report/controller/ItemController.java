...
public class ItemController {
	...
	// 공제항목별내역
	@RequestMapping(method = RequestMethod.GET , value = "getItem.do")
	@ResponseBody
	public ResponseEntity<JSONObject> getItemCtrl(@ModelAttribute("ItemVO") ItemVO itemVO,
		...
		try {
			System.out.println(":::::::::::::::::::: getItemCtrl :::::::::::::::::::");
			...
			if (loginVO == null || Integer.parseInt(loginVO.getUserType()) < 5) {
				...
				itemVO.setBizId(bizId);
				itemVO.setBizName(bizName);

				Map<String, Object> result = reportService.getItem(itemVO);
