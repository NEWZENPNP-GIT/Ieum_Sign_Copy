...
@Repository("yp003DAO")
public class YP003DAO extends EgovAbstractDAO {
	 ...
	 */
	public int getYP003DataCnt(YP000VO vo) throws Exception{
		return (Integer) select("yp003DAO.getYP003DataCnt", vo);
	}
	 ...
	 * @throws Exception
	 */
	public String getYP003TaxId() throws Exception {
		return (String) select("yp003DAO.getYP003TaxId");
	}
	
	
	// 연말정산_원천명세(급여정보) 입력
	public void insYP003(YP000VO vo) throws Exception{
		valueNullCheck(vo);
					
		insert("yp003DAO.insYP003", vo);		
	}
		
	// 간이지급명세서_원천명세(급여정보) 수정
	public int updYP003(YP000VO vo) throws Exception{
		valueNullCheck(vo);
	
		return update("yp003DAO.updYP003", vo);
	}
	
	// 간이지급명세서_원천명세(급여정보) 삭제
	public int delYP003(YP000VO vo) {
		return delete("yp003DAO.delYP003", vo);
	}
	 ...
	 * @param vo
	 */
	private void valueNullCheck(YP000VO vo){
